    ...
    <div className='fixed top-0 bottom-0 right-0 left-0 z-50 bg-neutral-800 bg-opacity-70 p-4 flex justify-center items-center'>
      <div className='bg-white w-full max-w-md p-4 rounded'>
           ...
           <div className='w-fit ml-auto flex items-center gap-3'>
                <button onClick={cancel} className='px-4 py-1 border rounded border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white'>Cancel</button>
                <button onClick={confirm} className='px-4 py-1 border rounded border-cyan-600 text-cyan-600 hover:bg-cyan-600 hover:text-white'>Confirm</button>
           </div>
      </div>
    </div>
  )
